          ...
          >
            ...
            >
              ...
              <span class="ml-6 flex flex-col">
                <span
                  ...
                  >Acesse a documentação</span
                >
                <span class="text-surface-600 dark:text-surface-200 lg:text-xl"
                  >Verifique se você digitou a URL corretamente.</span
                >
              </span>
            </a>
            <a
            ...
            >
              ...
              <span class="ml-6 flex flex-col">
                ...
                >
                <span class="text-surface-600 dark:text-surface-200 lg:text-xl"
                  >Entre em contato com um administrador.</span
                >
              </span>
            </a>
            <a
            ...
            >
              ...
              <span class="ml-6 flex flex-col">
                <span
                  class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0"
                  >Verifique suas credenciais de acesso</span
                >
                <span class="text-surface-600 dark:text-surface-200 lg:text-xl"
                  >Limpe o cache e tente novamente.</span
                >
              </span>
            </a>
